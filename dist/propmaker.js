export default class PropMaker {
  ...
  parseRule(rule) {
    ...
    if (numberRule) {
      return numberRule.mode === "random" ? this.makeRandomNumberGenerator(numberRule.min, numberRule.max) : this.makeCyclicNumberGenerator(numberRule.min, numberRule.max);
    }
